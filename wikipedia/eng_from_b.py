...
link = "https://en.wikipedia.org/w/index.php?title=Special:AllPages&from=Barry+Chamish"
while True:
    ...
    for r in res3:
        try:
            ...
            header = re.sub(r"[?/\\!:'\"<>*\n\r\t|]", "", header)
            with open(f"C:\\Users\\roman\\Desktop\\scraping\\wiki\\eng_b\\{header}___{len(text)}.txt", 'w',
                      encoding="utf-8") as f:
                f.write(text)
        except:
            print('бля')
