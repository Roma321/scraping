...
link = "https://ru.wikipedia.org/w/index.php?title=%D0%A1%D0%BB%D1%83%D0%B6%D0%B5%D0%B1%D0%BD%D0%B0%D1%8F:%D0%92%D1%81%D0%B5_%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%B8%D1%86%D1%8B&from=%D0%9F%D1%87%D1%91%D0%BB%D0%BA%D0%B0+%28%D0%BC%D0%BE%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F+%D0%BB%D0%BE%D0%B4%D0%BA%D0%B0%29"
while True:
    ...
    for r in res3:
        try:
            ...
            header = re.sub(r"[?/\\!:'\"<>*\n\r\t|]", "", header)
            with open(f"C:\\Users\\roman\\Desktop\\scraping\\wiki\\pp\\{header}___{len(text)}.txt", 'w',
                      encoding="utf-8") as f:
                f.write(text)
        except:
            print('бля')
